...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-300 via-slate-950 to-slate-300 text-white">
      {/* Barra superior */}
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 md:py-10 pb-14">
        <div className="grid gap-8 md:grid-cols-[1.6fr,1fr] items-start">
          ...
          <aside className="space-y-4 md:space-y-5">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-gray-700 to-black text-white p-6 shadow-lg flex flex-col justify-around min-h-[230px]">
              <div>
                <p className="text-[8px] uppercase tracking-[0.3em] text-purple-100/80">
            ...
            <div className="rounded-2xl bg-slate-900 border border-slate-700 p-4 text-slate-100 shadow-sm">
              ...
              <p className="text-xs text-slate-400 mt-3">
                “Cada línea de código que escribes en React es una oportunidad para crear experiencias únicas. No te preocupes si el camino parece complejo: cada error es un maestro y cada componente que construyes te acerca a tu meta. Mantén la curiosidad, sigue aprendiendo y recuerda que las grandes aplicaciones nacen de pequeños pasos bien dados. ¡Confía en tu proceso, porque el futuro digital lo estás creando tú mismo”
              </p>
            </div>
          </aside>
        </div>
